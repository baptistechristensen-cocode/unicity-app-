    ...
    const modalConfig = useMemo<{
        ...
        if (twoFactorEnabled) {
            return {
                ...
                description:
                    'L\'authentification à deux facteurs est maintenant active. Scannez le QR code ou saisissez la clé dans votre application d\'authentification.',
                buttonText: 'Fermer',
            };
        }
        ...
        if (showVerificationStep) {
            return {
                ...
                description:
                    'Saisissez le code à 6 chiffres fourni par votre application d\'authentification',
